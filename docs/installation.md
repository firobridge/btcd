...
* Download the Conformal public key:
  https://raw.githubusercontent.com/firobridge/btcd/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/firobridge/btcd/releases)
...
```bash
git clone https://github.com/firobridge/btcd $GOPATH/src/github.com/firobridge/btcd
...
* [Using bootstrap.dat](https://github.com/firobridge/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
