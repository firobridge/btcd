...
With Docker you can easily set up *btcd* to run your Bitcoin full node. You can find the official *btcd* Docker images on Docker Hub [firobridge/btcd](https://hub.docker.com/r/firobridge/btcd). The Docker source file of this image is located at [Dockerfile](https://github.com/firobridge/btcd/blob/master/Dockerfile).
